...
class DataLoaderLateral:
    def __init__(self, BASE_DIR='./whiskerLateralSweep'):
        ...
        if speed == 50:
            ...
            for grit_folder in os.listdir(milling_file_path):
                ...
                for file_name in os.listdir(grit_folder_path):
                    ...
                    split_window_arr, window_split_label_list = self.split_sweep_into_windows(data_arr,
    ...
    def load_full_data_with_labels(self, speed=50, window_size=50, axis_selection_tuple=(0,1, 2, 3, 4, 5),
                                   full_data_norm=False):
        full_arr_list = []
        full_label_list = []
        arr, label_arr = self.load_data(milling_type='', speed=speed, window_size=window_size,
                                        axis_selection_tuple=axis_selection_tuple,
...
# d = DataLoaderLateral()
# X, Y, classes, class_name = d.load_full_data_with_labels(speed=100, axis_selection_tuple=(0,1, 2, 3, 4, 5))
# print(class_name)
